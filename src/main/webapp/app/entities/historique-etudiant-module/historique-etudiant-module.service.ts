...
export class HistoriqueEtudiantModuleService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/historique-etudiant-modules';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IHistoriqueEtudiantModule[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
