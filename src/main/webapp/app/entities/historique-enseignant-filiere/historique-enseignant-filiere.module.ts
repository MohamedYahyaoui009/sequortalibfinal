...
@NgModule({
  imports: [SequortalibfinalSharedModule, RouterModule.forChild(historiqueEnseignantFiliereRoute)],
  declarations: [
...
export class SequortalibfinalHistoriqueEnseignantFiliereModule {}
