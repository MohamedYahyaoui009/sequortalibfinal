...
export class HistoriqueEnseignantFiliereService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/historique-enseignant-filieres';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IHistoriqueEnseignantFiliere[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
