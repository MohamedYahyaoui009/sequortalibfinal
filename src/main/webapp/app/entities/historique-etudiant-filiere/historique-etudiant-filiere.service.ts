...
export class HistoriqueEtudiantFiliereService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/historique-etudiant-filieres';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IHistoriqueEtudiantFiliere[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
