...
export class HistoriqueEnseignantModuleService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/historique-enseignant-modules';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IHistoriqueEnseignantModule[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
