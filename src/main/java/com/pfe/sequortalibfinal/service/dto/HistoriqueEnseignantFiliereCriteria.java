...
/**
 * Criteria class for the {@link com.pfe.sequortalibfinal.domain.HistoriqueEnseignantFiliere} entity. This class is used
 * in {@link com.pfe.sequortalibfinal.web.rest.HistoriqueEnseignantFiliereResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /historique-enseignant-filieres?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class HistoriqueEnseignantFiliereCriteria implements Serializable, Criteria {
    ...
    public HistoriqueEnseignantFiliereCriteria() {
    }

    public HistoriqueEnseignantFiliereCriteria(HistoriqueEnseignantFiliereCriteria other) {
    ...
    @Override
    public HistoriqueEnseignantFiliereCriteria copy() {
        return new HistoriqueEnseignantFiliereCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HistoriqueEnseignantFiliereCriteria that = (HistoriqueEnseignantFiliereCriteria) o;
        return
    ...
    public String toString() {
        return "HistoriqueEnseignantFiliereCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
