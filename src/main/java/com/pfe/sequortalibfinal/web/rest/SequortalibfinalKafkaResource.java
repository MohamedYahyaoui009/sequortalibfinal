...
@RestController
@RequestMapping("/api/sequortalibfinal-kafka")
public class SequortalibfinalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SequortalibfinalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SequortalibfinalKafkaResource(KafkaProperties kafkaProperties) {
